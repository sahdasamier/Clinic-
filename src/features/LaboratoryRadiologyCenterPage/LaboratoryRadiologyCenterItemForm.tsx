...
const InventoryItemForm: React.FC = () => {
  ...
  const { 
    ...
    isDirty,
    lastSaved 
  } = usePersistentForm('laboratoryRadiologyItemForm', defaultFormData, { 
    autoSave: true, 
    autoSaveDelay: 2000 
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('🔄 Save laboratoryRadiology item clicked!');
    ...
    try {
      ...
      setError('Failed to save laboratoryRadiology item. Please try again.');
    } finally {
      setLoading(false);
    }
  };
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                ...
                <Box>
                  ...
                  <Typography variant="h6" sx={{ opacity: 0.9, fontWeight: 400 }}>
                    📦 Enter laboratoryRadiology item details below
                  </Typography>
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      helperText="Enter the name of the laboratoryRadiology item"
                    />
                  </Grid>
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      placeholder="Enter detailed description of the laboratoryRadiology item"
