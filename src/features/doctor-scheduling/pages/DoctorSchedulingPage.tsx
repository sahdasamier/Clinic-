...
// Doctor scheduling configuration and constants
const timeSlots = ['09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00'];
// const medicalSpecialties = ['General Medicine', 'Cardiology', 'Dermatology', 'Pediatrics', 'Orthopedics', 'Neurology'];
const appointmentTypes = ['Consultation', 'Follow-up', 'Emergency', 'Surgery', 'Checkup'];

const defaultDoctorFormData = {
  name: '',
  specialty: '',
  email: '',
  phone: '',
...
const defaultTimeSlotFormData = {
  time: '',
  duration: 30,
  isAvailable: true
};

// Doctor interface for scheduling
interface Doctor {
  id: string;
  name: string;
  specialty: string;
...
const DoctorSchedulingPage: React.FC = () => {
  ...
  } = usePersistentForm('doctor-scheduling-form', {
    time: '',
  ...
  const { 
    ...
    updateField: updateDoctorField, 
    handleSave: saveDoctorData, 
    resetForm: resetDoctorForm, 
    isDirty: isDoctorFormDirty, 
    lastSaved: doctorFormLastSaved 
  } = usePersistentForm('doctor-form-data', defaultDoctorFormData, { autoSave: true, autoSaveDelay: 2000 });
  ...
  const handleEditAppointment = (appointment: Appointment) => {
    ...
    updateFormField('time', appointment.timeSlot);
  ...
  const handleEditDoctor = (doctor: any) => {
    ...
    updateDoctorField('name', doctor.name);
    updateDoctorField('specialty', doctor.specialty);
    updateDoctorField('workingHoursStart', doctor.workingHours.start);
    updateDoctorField('workingHoursEnd', doctor.workingHours.end);
    updateDoctorField('offDays', doctor.offDays);
    updateDoctorField('consultationDuration', doctor.consultationDuration);
    updateDoctorField('maxPatientsPerHour', doctor.maxPatientsPerHour);
             ...
             <Grid container spacing={4}>
               ...
               <Grid item xs={12}>
                 <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 3 }}>
                   <Typography variant="h6" sx={{ fontWeight: 700, color: '#2e7d32', display: 'flex', alignItems: 'center', gap: 1 }}>
               ...
               <Grid item xs={12} md={6}>
                 <FormControl fullWidth sx={{
                   ...
                   <Select
                     ...
                     onChange={(e) => updateDoctorField('specialty', e.target.value)}
                     required
                   >
               ...
               <Grid item xs={12} md={6}>
                 <TextField
                   ...
                   onChange={(e) => updateDoctorField("workingHoursStart", e.target.value)}
                   InputLabelProps={{ shrink: true }}
                   sx={{
                     '& .MuiOutlinedInput-root': {
                       borderRadius: 3,
               ...
               <Grid item xs={12} md={6}>
                 <TextField
                   ...
                   onChange={(e) => updateDoctorField("workingHoursEnd", e.target.value)}
                   InputLabelProps={{ shrink: true }}
                   sx={{
                     '& .MuiOutlinedInput-root': {
                       borderRadius: 3,
               ...
               <Grid item xs={12} md={4}>
                 <TextField
                   ...
                   onChange={(e) => updateDoctorField("maxPatientsPerHour", parseInt(e.target.value) || 2)}
               ...
               <Grid item xs={12} md={4}>
                 <FormControl fullWidth sx={{
                   ...
                   <Select
                     ...
                     onChange={(e) => updateDoctorField("offDays", e.target.value as string[])}
                     label={t('off_days')}
