...
const appointmentTypesOptions = ['Consultation', 'Follow-up', 'Emergency', 'Surgery', 'Checkup'];
...
import AutoSyncIndicator from '@components/common/AutoSyncIndicator';
import AvailableTimeSlotsSelector from '@features/appointments/components/AvailableTimeSlotsSelector';
import PaymentStatusIndicator from '@features/payments/components/PaymentStatusIndicator';
