 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sg{constructor(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const t=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(t)){const n=new hg;if(this.instancesDeferred.set(t,n),this.isInitialized(t)||this.shouldAutoInitialize())try{const i=this.getOrInitializeService({instanceIdentifier:t});i&&n.resolve(i)}catch{}}return this.instancesDeferred.get(t).promise}getImmediate(e){var t;const n=this.normalizeInstanceIdentifier(e==null?void 0:e.identifier),i=(t=e==null?void 0:e.optional)!==null&&t!==void 0?t:!1;if(this.isInitialized(n)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:n})}catch(s){if(i)return null;throw s}else{if(i)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(Vg(e))try{this.getOrInitializeService({instanceIdentifier:Yt})}catch{}for(const[t,n]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(t);try{const s=this.getOrInitializeService({instanceIdentifier:i});n.resolve(s)}catch{}}}}clearInstance(e=Yt){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(t=>"INTERNAL"in t).map(t=>t.INTERNAL.delete()),...e.filter(t=>"_delete"in t).map(t=>t._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=Yt){return this.instances.has(e)}getOptions(e=Yt){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:t={}}=e,n=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(n))throw Error(`${this.name}(${n}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const i=this.getOrInitializeService({instanceIdentifier:n,options:t});for(const[s,o]of this.instancesDeferred.entries()){const c=this.normalizeInstanceIdentifier(s);n===c&&o.resolve(i)}return i}onInit(e,t){var n;const i=this.normalizeInstanceIdentifier(t),s=(n=this.onInitCallbacks.get(i))!==null&&n!==void 0?n:new Set;s.add(e),this.onInitCallbacks.set(i,s);const o=this.instances.get(i);return o&&e(o,i),()=>{s.delete(e)}}invokeOnInitCallbacks(e,t){const n=this.onInitCallbacks.get(t);if(n)for(const i of n)try{i(e,t)}catch{}}getOrInitializeService({instanceIdentifier:e,options:t={}}){let n=this.instances.get(e);if(!n&&this.component&&(n=this.component.instanceFactory(this.container,{instanceIdentifier:Cg(e),options:t}),this.instances.set(e,n),this.instancesOptions.set(e,t),this.invokeOnInitCallbacks(n,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,n)}catch{}return n||null}normalizeInstanceIdentifier(e=Yt){return this.component?this.component.multipleInstances?e:Yt:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Cg(r){return r===Yt?void 0:r}function Vg(r){return r.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ar=v_;function R_(r,e={}){let t=r;typeof e!="object"&&(e={name:e});const n=Object.assign({name:ma,automaticDataCollectionEnabled:!0},e),i=n.name;if(typeof i!="string"||!i)throw xt.create("bad-app-name",{appName:String(i)});if(t||(t=od()),!t)throw xt.create("no-options");const s=ln.get(i);if(s){if(Lt(t,s.options)&&Lt(n,s.config))return s;throw xt.create("duplicate-app",{appName:i})}const o=new Dg(i);for(const u of _a.values())o.addComponent(u);const c=new A_(t,n,o);return ln.set(i,c),c}function md(r=ma){const e=ln.get(r);if(!e&&r===ma&&od())return R_();if(!e)throw xt.create("no-app",{appName:r});return e}function Mw(){return Array.from(ln.values())}async function Lw(r){let e=!1;const t=r.name;ln.has(t)?(e=!0,ln.delete(t)):ga.has(t)&&r.decRefCount()<=0&&(ga.delete(t),e=!0),e&&(await Promise.all(r.container.getProviders().map(n=>n.delete())),r.isDeleted=!0)}function sn(r,e,t){var n;let i=(n=T_[r])!==null&&n!==void 0?n:r;t&&(i+=`-${t}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const c=[`Unable to register library "${i}" with version "${e}":`];s&&c.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ht.warn(c.join(" "));return}Kn(new un(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gy(r,e){const t=Js(r,"auth");if(t.isInitialized()){const i=t.getImmediate(),s=t.getOptions();if(Lt(s,e??{}))return i;ze(i,"already-initialized")}return t.initialize({options:e})}function _y(r,e){const t=(e==null?void 0:e.persistence)||[],n=(Array.isArray(t)?t:[t]).map(at);e!=null&&e.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(n,e==null?void 0:e.popupRedirectResolver)}function yy(r,e,t){const n=gt(r);F(/^https?:\/\//.test(e),n,"invalid-emulator-scheme");const i=!1,s=Fd(e),{host:o,port:c}=Iy(e),u=c===null?"":`:${c}`,h={url:`${s}//${o}${u}/`},f=Object.freeze({host:o,port:c,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!n._canInitEmulator){F(n.config.emulator&&n.emulatorConfig,n,"emulator-config-failed"),F(Lt(h,n.config.emulator)&&Lt(f,n.emulatorConfig),n,"emulator-config-failed");return}n.config.emulator=h,n.emulatorConfig=f,n.settings.appVerificationDisabledForTesting=!0,or(o)?(Ka(`${s}//${o}${u}`),cd("Auth",!0)):Ey()}function Fd(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function Iy(r){const e=Fd(r),t=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!t)return{host:"",port:null};const n=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(n);if(i){const s=i[1];return{host:s,port:El(n.substr(s.length+1))}}else{const[s,o]=n.split(":");return{host:s,port:El(o)}}}function El(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function Ey(){function r(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zd(r,e,t=!1){if(Be(r.app))return Promise.reject(ut(r));const n="signIn",i=await qd(r,n,e),s=await fn._fromIdTokenResponse(r,n,i);return t||await r._updateCurrentUser(s.user),s}async function Ny(r,e){return zd(gt(r),e)}async function Fw(r,e){return jd(ne(r),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ic(r){const e=gt(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Uw(r,e,t){const n=gt(r),i={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&xy(n,i,t),await Cs(n,i,"getOobCode",Ry)}async function Bw(r,e,t){await Ud(ne(r),{oobCode:e,newPassword:t}).catch(async n=>{throw n.code==="auth/password-does-not-meet-requirements"&&ic(r),n})}async function Oy(r,e){const t=ne(r),n=await Ud(t,{oobCode:e}),i=n.requestType;switch(F(i,t,"internal-error"),i){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":F(n.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":F(n.mfaInfo,t,"internal-error");default:F(n.email,t,"internal-error")}let s=null;return n.mfaInfo&&(s=tc._fromServerResponse(gt(t),n.mfaInfo)),{data:{email:(n.requestType==="VERIFY_AND_CHANGE_EMAIL"?n.newEmail:n.email)||null,previousEmail:(n.requestType==="VERIFY_AND_CHANGE_EMAIL"?n.email:n.newEmail)||null,multiFactorInfo:s},operation:i}}async function qw(r,e){const{data:t}=await Oy(ne(r),e);return t.email}async function jw(r,e,t){if(Be(r.app))return Promise.reject(ut(r));const n=gt(r),o=await Cs(n,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Dy).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&ic(r),u}),c=await fn._fromIdTokenResponse(n,"signIn",o);return await n._updateCurrentUser(c.user),c}function zw(r,e,t){return Be(r.app)?Promise.reject(ut(r)):Ny(ne(r),cr.credential(e,t)).catch(async n=>{throw n.code==="auth/password-does-not-meet-requirements"&&ic(r),n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $w(r,e){const t=vd()?bs():"http://localhost",n={identifier:e,continueUri:t},{signinMethods:i}=await My(ne(r),n);return i||[]}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kw(r,{displayName:e,photoURL:t}){if(e===void 0&&t===void 0)return;const n=ne(r),s={idToken:await n.getIdToken(),displayName:e,photoUrl:t,returnSecureToken:!0},o=await hn(n,Ly(n.auth,s));n.displayName=o.displayName||null,n.photoURL=o.photoUrl||null;const c=n.providerData.find(({providerId:u})=>u==="password");c&&(c.displayName=n.displayName,c.photoURL=n.photoURL),await n._updateTokensIfNecessary(o)}function Gw(r,e){return Fy(ne(r),null,e)}async function Fy(r,e,t){const{auth:n}=r,s={idToken:await r.getIdToken(),returnSecureToken:!0};t&&(s.password=t);const o=await hn(r,vy(n,s));await r._updateTokensIfNecessary(o,!0)}function Uy(r,e,t,n){return ne(r).onIdTokenChanged(e,t,n)}function By(r,e,t){return ne(r).beforeAuthStateChanged(e,t)}function Hw(r,e,t,n){return ne(r).onAuthStateChanged(e,t,n)}function Ww(r){return ne(r).signOut()}async function Qw(r){return ne(r).delete()}const Ds="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rE(r){const e=typeof self<"u"&&(self.crypto||self.msCrypto),t=new Uint8Array(r);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(t);else for(let n=0;n<r;n++)t[n]=Math.floor(256*Math.random());return t}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on=-1;function no(r){return r==null}function si(r){return r===0&&1/r==-1/0}function hE(r){return typeof r=="number"&&Number.isInteger(r)&&!si(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xt="remoteDocuments",wi="owner",Sn="owner",oi="mutationQueues",fE="userId",Ke="mutations",ql="batchId",rn="userMutationsIndex",jl=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ms(r,e){return[r,Se(e)]}function gf(r,e,t){return[r,Se(e),t]}const pE={},Hn="documentMutations",Os="remoteDocumentsV14",mE=["prefixPath","collectionGroup","readTime","documentId"],gs="documentKeyIndex",gE=["prefixPath","collectionGroup","documentId"],_f="collectionGroupIndex",_E=["collectionGroup","readTime","prefixPath","documentId"],ai="remoteDocumentGlobal",wa="remoteDocumentGlobalKey",Wn="targets",yf="queryTargetsIndex",yE=["canonicalId","targetId"],Qn="targetDocuments",IE=["targetId","path"],hc="documentTargetsIndex",EE=["path","targetId"],Ms="targetGlobalKey",an="targetGlobal",ci="collectionParents",vE=["collectionId","parent"],Yn="clientMetadata",TE="clientId",ro="bundles",wE="bundleId",io="namedQueries",AE="name",dc="indexConfiguration",RE="indexId",Aa="collectionGroupIndex",bE="collectionGroup",Wr="indexState",PE=["indexId","uid"],If="sequenceNumberIndex",SE=["uid","sequenceNumber"],Qr="indexEntries",CE=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],Ef="documentKeyIndex",VE=["indexId","uid","orderedDocumentKey"],so="documentOverlays",DE=["userId","collectionPath","documentId"],Ra="collectionPathOverlayIndex",kE=["userId","collectionPath","largestBatchId"],vf="collectionGroupOverlayIndex",NE=["userId","collectionGroup","largestBatchId"],fc="globals",xE="name",Tf=[oi,Ke,Hn,Xt,Wn,wi,an,Qn,Yn,ai,ci,ro,io],OE=[...Tf,so],wf=[oi,Ke,Hn,Os,Wn,wi,an,Qn,Yn,ai,ci,ro,io,so],Af=wf,pc=[...Af,dc,Wr,Qr],ME=pc,Rf=[...pc,fc],LE=Rf;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ba extends pf{constructor(e,t){super(),this.he=e,this.currentSequenceNumber=t}}function me(r,e){const t=z(r);return Mt.N(t.he,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zl(r){let e=0;for(const t in r)Object.prototype.hasOwnProperty.call(r,t)&&e++;return e}function $t(r,e){for(const t in r)Object.prototype.hasOwnProperty.call(r,t)&&e(t,r[t])}function bf(r){for(const e in r)if(Object.prototype.hasOwnProperty.call(r,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class he{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(i){try{return atob(i)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new Pf("Invalid base64 string: "+s):s}}(e);return new he(t)}static fromUint8Array(e){const t=function(i){let s="";for(let o=0;o<i.length;++o)s+=String.fromCharCode(i[o]);return s}(e);return new he(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const n=new Uint8Array(t.length);for(let i=0;i<t.length;i++)n[i]=t.charCodeAt(i);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return j(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}he.EMPTY_BYTE_STRING=new he("");const FE=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function ft(r){if(U(!!r,39018),typeof r=="string"){let e=0;const t=FE.exec(r);if(U(!!t,46558,{timestamp:r}),t[1]){let i=t[1];i=(i+"000000000").substr(0,9),e=Number(i)}const n=new Date(r);return{seconds:Math.floor(n.getTime()/1e3),nanos:e}}return{seconds:se(r.seconds),nanos:se(r.nanos)}}function se(r){return typeof r=="number"?r:typeof r=="string"?Number(r):0}function pt(r){return typeof r=="string"?he.fromBase64String(r):he.fromUint8Array(r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class UE{constructor(e,t,n,i,s,o,c,u,h,f){this.databaseId=e,this.appId=t,this.persistenceKey=n,this.host=i,this.ssl=s,this.forceLongPolling=o,this.autoDetectLongPolling=c,this.longPollingOptions=u,this.useFetchStreams=h,this.isUsingEmulator=f}}const li="(default)";class Ft{constructor(e,t){this.projectId=e,this.database=t||li}static empty(){return new Ft("","")}get isDefaultDatabase(){return this.database===li}isEqual(e){return e instanceof Ft&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pi{constructor(e,t="asc"){this.field=e,this.dir=t}}function jE(r,e){return r.dir===e.dir&&r.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QE{constructor(e,t=null,n=[],i=[],s=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=i,this.limit=s,this.startAt=o,this.endAt=c,this.Ie=null}}function Da(r,e=null,t=[],n=[],i=null,s=null,o=null){return new QE(r,e,t,n,i,s,o)}function gn(r){const e=z(r);if(e.Ie===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(n=>Va(n)).join(","),t+="|ob:",t+=e.orderBy.map(n=>function(s){return s.field.canonicalString()+s.dir}(n)).join(","),no(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(n=>Xn(n)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(n=>Xn(n)).join(",")),e.Ie=t}return e.Ie}function Ai(r,e){if(r.limit!==e.limit||r.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<r.orderBy.length;t++)if(!jE(r.orderBy[t],e.orderBy[t]))return!1;if(r.filters.length!==e.filters.length)return!1;for(let t=0;t<r.filters.length;t++)if(!Ff(r.filters[t],e.filters[t]))return!1;return r.collectionGroup===e.collectionGroup&&!!r.path.isEqual(e.path)&&!!Xl(r.startAt,e.startAt)&&Xl(r.endAt,e.endAt)}function Ls(r){return O.isDocumentKey(r.path)&&r.collectionGroup===null&&r.filters.length===0}function Fs(r,e){return r.filters.filter(t=>t instanceof Q&&t.field.isEqual(e))}function Zl(r,e,t){let n=_s,i=!0;for(const s of Fs(r,e)){let o=_s,c=!0;switch(s.op){case"<":case"<=":o=BE(s.value);break;case"==":case"in":case">=":o=s.value;break;case">":o=s.value,c=!1;break;case"!=":case"not-in":o=_s}Ql({value:n,inclusive:i},{value:o,inclusive:c})<0&&(n=o,i=c)}if(t!==null){for(let s=0;s<r.orderBy.length;++s)if(r.orderBy[s].field.isEqual(e)){const o=t.position[s];Ql({value:n,inclusive:i},{value:o,inclusive:t.inclusive})<0&&(n=o,i=t.inclusive);break}}return{value:n,inclusive:i}}function eh(r,e,t){let n=kt,i=!0;for(const s of Fs(r,e)){let o=kt,c=!0;switch(s.op){case">=":case">":o=qE(s.value),c=!1;break;case"==":case"in":case"<=":o=s.value;break;case"<":o=s.value,c=!1;break;case"!=":case"not-in":o=kt}Yl({value:n,inclusive:i},{value:o,inclusive:c})>0&&(n=o,i=c)}if(t!==null){for(let s=0;s<r.orderBy.length;++s)if(r.orderBy[s].field.isEqual(e)){const o=t.position[s];Yl({value:n,inclusive:i},{value:o,inclusive:t.inclusive})>0&&(n=o,i=t.inclusive);break}}return{value:n,inclusive:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _t{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),n=this.inner[t];if(n!==void 0){for(const[i,s]of n)if(this.equalsFn(i,e))return s}}has(e){return this.get(e)!==void 0}set(e,t){const n=this.mapKeyFn(e),i=this.inner[n];if(i===void 0)return this.inner[n]=[[e,t]],void this.innerSize++;for(let s=0;s<i.length;s++)if(this.equalsFn(i[s][0],e))return void(i[s]=[e,t]);i.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),n=this.inner[t];if(n===void 0)return!1;for(let i=0;i<n.length;i++)if(this.equalsFn(n[i][0],e))return n.length===1?delete this.inner[t]:n.splice(i,1),this.innerSize--,!0;return!1}forEach(e){$t(this.inner,(t,n)=>{for(const[i,s]of n)e(i,s)})}isEmpty(){return bf(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ev=new ce(O.comparator);function Le(){return ev}const Gf=new ce(O.comparator);function qr(...r){let e=Gf;for(const t of r)e=e.insert(t.key,t);return e}function Hf(r){let e=Gf;return r.forEach((t,n)=>e=e.insert(t,n.overlayedDocument)),e}function Je(){return Xr()}function Wf(){return Xr()}function Xr(){return new _t(r=>r.toString(),(r,e)=>r.isEqual(e))}const tv=new ce(O.comparator),nv=new te(O.comparator);function K(...r){let e=nv;for(const t of r)e=e.add(t);return e}const rv=new te(j);function iv(){return rv}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ic(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:si(e)?"-0":e}}function Qf(r){return{integerValue:""+r}}function sv(r,e){return hE(e)?Qf(e):Ic(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pv=new Ot([4294967295,4294967295],0);function oh(r){const e=lf().encode(r),t=new ef;return t.update(e),new Uint8Array(t.digest())}function ah(r){const e=new DataView(r.buffer),t=e.getUint32(0,!0),n=e.getUint32(4,!0),i=e.getUint32(8,!0),s=e.getUint32(12,!0);return[new Ot([t,n],0),new Ot([i,s],0)]}class wc{constructor(e,t,n){if(this.bitmap=e,this.padding=t,this.hashCount=n,t<0||t>=8)throw new jr(`Invalid padding: ${t}`);if(n<0)throw new jr(`Invalid hash count: ${n}`);if(e.length>0&&this.hashCount===0)throw new jr(`Invalid hash count: ${n}`);if(e.length===0&&t!==0)throw new jr(`Invalid padding when bitmap length is 0: ${t}`);this.pe=8*e.length-t,this.ye=Ot.fromNumber(this.pe)}we(e,t,n){let i=e.add(t.multiply(Ot.fromNumber(n)));return i.compare(pv)===1&&(i=new Ot([i.getBits(0),i.getBits(1)],0)),i.modulo(this.ye).toNumber()}be(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.pe===0)return!1;const t=oh(e),[n,i]=ah(t);for(let s=0;s<this.hashCount;s++){const o=this.we(n,i,s);if(!this.be(o))return!1}return!0}static create(e,t,n){const i=e%8==0?0:8-e%8,s=new Uint8Array(Math.ceil(e/8)),o=new wc(s,i,t);return n.forEach(c=>o.insert(c)),o}insert(e){if(this.pe===0)return;const t=oh(e),[n,i]=ah(t);for(let s=0;s<this.hashCount;s++){const o=this.we(n,i,s);this.Se(o)}}Se(e){const t=Math.floor(e/8),n=e%8;this.bitmap[t]|=1<<n}}class jr extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dv{Dt(e){return me(e,fc)}getSessionToken(e){return this.Dt(e).get("sessionToken").next(t=>{const n=t==null?void 0:t.value;return n?he.fromUint8Array(n):he.EMPTY_BYTE_STRING})}setSessionToken(e,t){return this.Dt(e).put({name:"sessionToken",value:t.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lv{constructor(){this.Cn=new bc}addToCollectionParentIndex(e,t){return this.Cn.add(t),w.resolve()}getCollectionParents(e,t){return w.resolve(this.Cn.getEntries(t))}addFieldIndex(e,t){return w.resolve()}deleteFieldIndex(e,t){return w.resolve()}deleteAllFieldIndexes(e){return w.resolve()}createTargetIndexes(e,t){return w.resolve()}getDocumentsMatchingTarget(e,t){return w.resolve(null)}getIndexType(e,t){return w.resolve(0)}getFieldIndexes(e,t){return w.resolve([])}getNextCollectionGroupToUpdate(e){return w.resolve(null)}getMinOffset(e,t){return w.resolve(Fe.min())}getMinOffsetFromCollectionGroup(e,t){return w.resolve(Fe.min())}updateCollectionGroup(e,t,n){return w.resolve()}updateIndexEntries(e,t){return w.resolve()}}class bc{constructor(){this.index={}}add(e){const t=e.lastSegment(),n=e.popLast(),i=this.index[t]||new te(X.comparator),s=!i.has(n);return this.index[t]=i.add(n),s}has(e){const t=e.lastSegment(),n=e.popLast(),i=this.index[t];return i&&i.has(n)}getEntries(e){return(this.index[e]||new te(X.comparator)).toArray()}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wv{constructor(){this.sessionToken=he.EMPTY_BYTE_STRING}getSessionToken(e){return w.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,w.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eT{constructor(e){this.serializer=e}q(e,t,n,i){const s=new to("createOrUpgrade",t);n<1&&i>=1&&(function(u){u.createObjectStore(wi)}(e),function(u){u.createObjectStore(oi,{keyPath:fE}),u.createObjectStore(Ke,{keyPath:ql,autoIncrement:!0}).createIndex(rn,jl,{unique:!0}),u.createObjectStore(Hn)}(e),Dh(e),function(u){u.createObjectStore(Xt)}(e));let o=w.resolve();return n<3&&i>=3&&(n!==0&&(function(u){u.deleteObjectStore(Qn),u.deleteObjectStore(Wn),u.deleteObjectStore(an)}(e),Dh(e)),o=o.next(()=>function(u){const h=u.store(an),f={highestTargetId:0,highestListenSequenceNumber:0,lastRemoteSnapshotVersion:q.min().toTimestamp(),targetCount:0};return h.put(Ms,f)}(s))),n<4&&i>=4&&(n!==0&&(o=o.next(()=>function(u,h){return h.store(Ke).J().next(m=>{u.deleteObjectStore(Ke),u.createObjectStore(Ke,{keyPath:ql,autoIncrement:!0}).createIndex(rn,jl,{unique:!0});const g=h.store(Ke),b=m.map(C=>g.put(C));return w.waitFor(b)})}(e,s))),o=o.next(()=>{(function(u){u.createObjectStore(Yn,{keyPath:TE})})(e)})),n<5&&i>=5&&(o=o.next(()=>this.wi(s))),n<6&&i>=6&&(o=o.next(()=>(function(u){u.createObjectStore(ai)}(e),this.bi(s)))),n<7&&i>=7&&(o=o.next(()=>this.Si(s))),n<8&&i>=8&&(o=o.next(()=>this.Di(e,s))),n<9&&i>=9&&(o=o.next(()=>{(function(u){u.objectStoreNames.contains("remoteDocumentChanges")&&u.deleteObjectStore("remoteDocumentChanges")})(e)})),n<10&&i>=10&&(o=o.next(()=>this.Ci(s))),n<11&&i>=11&&(o=o.next(()=>{(function(u){u.createObjectStore(ro,{keyPath:wE})})(e),function(u){u.createObjectStore(io,{keyPath:AE})}(e)})),n<12&&i>=12&&(o=o.next(()=>{(function(u){const h=u.createObjectStore(so,{keyPath:DE});h.createIndex(Ra,kE,{unique:!1}),h.createIndex(vf,NE,{unique:!1})})(e)})),n<13&&i>=13&&(o=o.next(()=>function(u){const h=u.createObjectStore(Os,{keyPath:mE});h.createIndex(gs,gE),h.createIndex(_f,_E)}(e)).next(()=>this.Fi(e,s)).next(()=>e.deleteObjectStore(Xt))),n<14&&i>=14&&(o=o.next(()=>this.Mi(e,s))),n<15&&i>=15&&(o=o.next(()=>function(u){u.createObjectStore(dc,{keyPath:RE,autoIncrement:!0}).createIndex(Aa,bE,{unique:!1}),u.createObjectStore(Wr,{keyPath:PE}).createIndex(If,SE,{unique:!1}),u.createObjectStore(Qr,{keyPath:CE}).createIndex(Ef,VE,{unique:!1})}(e))),n<16&&i>=16&&(o=o.next(()=>{t.objectStore(Wr).clear()}).next(()=>{t.objectStore(Qr).clear()})),n<17&&i>=17&&(o=o.next(()=>{(function(u){u.createObjectStore(fc,{keyPath:xE})})(e)})),n<18&&i>=18&&hd()&&(o=o.next(()=>{t.objectStore(Wr).clear()}).next(()=>{t.objectStore(Qr).clear()})),o}bi(e){let t=0;return e.store(Xt).te((n,i)=>{t+=$s(i)}).next(()=>{const n={byteSize:t};return e.store(ai).put(wa,n)})}wi(e){const t=e.store(oi),n=e.store(Ke);return t.J().next(i=>w.forEach(i,s=>{const o=IDBKeyRange.bound([s.userId,on],[s.userId,s.lastAcknowledgedBatchId]);return n.J(rn,o).next(c=>w.forEach(c,u=>{U(u.userId===s.userId,18650,"Cannot process batch from unexpected user",{batchId:u.batchId});const h=en(this.serializer,u);return Ap(e,s.userId,h).next(()=>{})}))}))}Si(e){const t=e.store(Qn),n=e.store(Xt);return e.store(an).get(Ms).next(i=>{const s=[];return n.te((o,c)=>{const u=new X(o),h=function(m){return[0,Se(m)]}(u);s.push(t.get(h).next(f=>f?w.resolve():(m=>t.put({targetId:0,path:Se(m),sequenceNumber:i.highestListenSequenceNumber}))(u)))}).next(()=>w.waitFor(s))})}Di(e,t){e.createObjectStore(ci,{keyPath:vE});const n=t.store(ci),i=new bc,s=o=>{if(i.add(o)){const c=o.lastSegment(),u=o.popLast();return n.put({collectionId:c,parent:Se(u)})}};return t.store(Xt).te({ee:!0},(o,c)=>{const u=new X(o);return s(u.popLast())}).next(()=>t.store(Hn).te({ee:!0},([o,c,u],h)=>{const f=Ye(c);return s(f.popLast())}))}Ci(e){const t=e.store(Wn);return t.te((n,i)=>{const s=zr(i),o=Ip(this.serializer,s);return t.put(o)})}Fi(e,t){const n=t.store(Xt),i=[];return n.te((s,o)=>{const c=t.store(Os),u=function(m){return m.document?new O(X.fromString(m.document.name).popFirst(5)):m.noDocument?O.fromSegments(m.noDocument.path):m.unknownDocument?O.fromSegments(m.unknownDocument.path):M(36783)}(o).path.toArray(),h={prefixPath:u.slice(0,u.length-2),collectionGroup:u[u.length-2],documentId:u[u.length-1],readTime:o.readTime||[0,0],unknownDocument:o.unknownDocument,noDocument:o.noDocument,document:o.document,hasCommittedMutations:!!o.hasCommittedMutations};i.push(c.put(h))}).next(()=>w.waitFor(i))}Mi(e,t){const n=t.store(Ke),i=Dp(this.serializer),s=new Sc(mo.fi,this.serializer.wt);return n.J().next(o=>{const c=new Map;return o.forEach(u=>{var h;let f=(h=c.get(u.userId))!==null&&h!==void 0?h:K();en(this.serializer,u).keys().forEach(m=>f=f.add(m)),c.set(u.userId,f)}),w.forEach(c,(u,h)=>{const f=new ye(h),m=fo.bt(this.serializer,f),g=s.getIndexManager(f),b=po.bt(f,this.serializer,g,s.referenceDelegate);return new kp(i,b,m,g).recalculateAndSaveOverlaysForDocumentKeys(new ba(t,qe.le),u).next()})})}}function Dh(r){r.createObjectStore(Qn,{keyPath:IE}).createIndex(hc,EE,{unique:!0}),r.createObjectStore(Wn,{keyPath:"targetId"}).createIndex(yf,yE,{unique:!0}),r.createObjectStore(an)}const bt="IndexedDbPersistence",oa=18e5,aa=5e3,ca="Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.",tT="main";class Cc{constructor(e,t,n,i,s,o,c,u,h,f,m=18){if(this.allowTabSynchronization=e,this.persistenceKey=t,this.clientId=n,this.xi=s,this.window=o,this.document=c,this.Oi=h,this.Ni=f,this.Bi=m,this.li=null,this.hi=!1,this.isPrimary=!1,this.networkEnabled=!0,this.Li=null,this.inForeground=!1,this.ki=null,this.qi=null,this.Qi=Number.NEGATIVE_INFINITY,this.$i=g=>Promise.resolve(),!Cc.C())throw new N(S.UNIMPLEMENTED,"This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");this.referenceDelegate=new jv(this,i),this.Ui=t+tT,this.serializer=new yp(u),this.Ki=new Mt(this.Ui,this.Bi,new eT(this.serializer)),this.Pi=new Dv,this.Ti=new Uv(this.referenceDelegate,this.serializer),this.remoteDocumentCache=Dp(this.serializer),this.Ei=new Vv,this.window&&this.window.localStorage?this.Wi=this.window.localStorage:(this.Wi=null,f===!1&&ke(bt,"LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."))}start(){return this.Gi().then(()=>{if(!this.isPrimary&&!this.allowTabSynchronization)throw new N(S.FAILED_PRECONDITION,ca);return this.zi(),this.ji(),this.Hi(),this.runTransaction("getHighestListenSequenceNumber","readonly",e=>this.Ti.getHighestSequenceNumber(e))}).then(e=>{this.li=new qe(e,this.Oi)}).then(()=>{this.hi=!0}).catch(e=>(this.Ki&&this.Ki.close(),Promise.reject(e)))}Ji(e){return this.$i=async t=>{if(this.started)return e(t)},e(this.isPrimary)}setDatabaseDeletedListener(e){this.Ki.U(async t=>{t.newVersion===null&&await e()})}setNetworkEnabled(e){this.networkEnabled!==e&&(this.networkEnabled=e,this.xi.enqueueAndForget(async()=>{this.started&&await this.Gi()}))}Gi(){return this.runTransaction("updateClientMetadataAndTryBecomePrimary","readwrite",e=>as(e).put({clientId:this.clientId,updateTimeMs:Date.now(),networkEnabled:this.networkEnabled,inForeground:this.inForeground}).next(()=>{if(this.isPrimary)return this.Yi(e).next(t=>{t||(this.isPrimary=!1,this.xi.enqueueRetryable(()=>this.$i(!1)))})}).next(()=>this.Zi(e)).next(t=>this.isPrimary&&!t?this.Xi(e).next(()=>!1):!!t&&this.es(e).next(()=>!0))).catch(e=>{if(zt(e))return V(bt,"Failed to extend owner lease: ",e),this.isPrimary;if(!this.allowTabSynchronization)throw e;return V(bt,"Releasing owner lease after error during lease refresh",e),!1}).then(e=>{this.isPrimary!==e&&this.xi.enqueueRetryable(()=>this.$i(e)),this.isPrimary=e})}Yi(e){return Lr(e).get(Sn).next(t=>w.resolve(this.ts(t)))}ns(e){return as(e).delete(this.clientId)}async rs(){if(this.isPrimary&&!this.ss(this.Qi,oa)){this.Qi=Date.now();const e=await this.runTransaction("maybeGarbageCollectMultiClientState","readwrite-primary",t=>{const n=me(t,Yn);return n.J().next(i=>{const s=this._s(i,oa),o=i.filter(c=>s.indexOf(c)===-1);return w.forEach(o,c=>n.delete(c.clientId)).next(()=>o)})}).catch(()=>[]);if(this.Wi)for(const t of e)this.Wi.removeItem(this.us(t.clientId))}}Hi(){this.qi=this.xi.enqueueAfterDelay("client_metadata_refresh",4e3,()=>this.Gi().then(()=>this.rs()).then(()=>this.Hi()))}ts(e){return!!e&&e.ownerId===this.clientId}Zi(e){return this.Ni?w.resolve(!0):Lr(e).get(Sn).next(t=>{if(t!==null&&this.ss(t.leaseTimestampMs,aa)&&!this.cs(t.ownerId)){if(this.ts(t)&&this.networkEnabled)return!0;if(!this.ts(t)){if(!t.allowTabSynchronization)throw new N(S.FAILED_PRECONDITION,ca);return!1}}return!(!this.networkEnabled||!this.inForeground)||as(e).J().next(n=>this._s(n,aa).find(i=>{if(this.clientId!==i.clientId){const s=!this.networkEnabled&&i.networkEnabled,o=!this.inForeground&&i.inForeground,c=this.networkEnabled===i.networkEnabled;if(s||o&&c)return!0}return!1})===void 0)}).next(t=>(this.isPrimary!==t&&V(bt,`Client ${t?"is":"is not"} eligible for a primary lease.`),t))}async shutdown(){this.hi=!1,this.ls(),this.qi&&(this.qi.cancel(),this.qi=null),this.hs(),this.Ps(),await this.Ki.runTransaction("shutdown","readwrite",[wi,Yn],e=>{const t=new ba(e,qe.le);return this.Xi(t).next(()=>this.ns(t))}),this.Ki.close(),this.Ts()}_s(e,t){return e.filter(n=>this.ss(n.updateTimeMs,t)&&!this.cs(n.clientId))}Is(){return this.runTransaction("getActiveClients","readonly",e=>as(e).J().next(t=>this._s(t,oa).map(n=>n.clientId)))}get started(){return this.hi}getGlobalsCache(){return this.Pi}getMutationQueue(e,t){return po.bt(e,this.serializer,t,this.referenceDelegate)}getTargetCache(){return this.Ti}getRemoteDocumentCache(){return this.remoteDocumentCache}getIndexManager(e){return new Fv(e,this.serializer.wt.databaseId)}getDocumentOverlayCache(e){return fo.bt(this.serializer,e)}getBundleCache(){return this.Ei}runTransaction(e,t,n){V(bt,"Starting transaction:",e);const i=t==="readonly"?"readonly":"readwrite",s=function(u){return u===18?LE:u===17?Rf:u===16?ME:u===15?pc:u===14?Af:u===13?wf:u===12?OE:u===11?Tf:void M(60245)}(this.Bi);let o;return this.Ki.runTransaction(e,i,s,c=>(o=new ba(c,this.li?this.li.next():qe.le),t==="readwrite-primary"?this.Yi(o).next(u=>!!u||this.Zi(o)).next(u=>{if(!u)throw ke(`Failed to obtain primary lease for action '${e}'.`),this.isPrimary=!1,this.xi.enqueueRetryable(()=>this.$i(!1)),new N(S.FAILED_PRECONDITION,ff);return n(o)}).next(u=>this.es(o).next(()=>u)):this.Es(o).next(()=>n(o)))).then(c=>(o.raiseOnCommittedEvent(),c))}Es(e){return Lr(e).get(Sn).next(t=>{if(t!==null&&this.ss(t.leaseTimestampMs,aa)&&!this.cs(t.ownerId)&&!this.ts(t)&&!(this.Ni||this.allowTabSynchronization&&t.allowTabSynchronization))throw new N(S.FAILED_PRECONDITION,ca)})}es(e){const t={ownerId:this.clientId,allowTabSynchronization:this.allowTabSynchronization,leaseTimestampMs:Date.now()};return Lr(e).put(Sn,t)}static C(){return Mt.C()}Xi(e){const t=Lr(e);return t.get(Sn).next(n=>this.ts(n)?(V(bt,"Releasing primary lease."),t.delete(Sn)):w.resolve())}ss(e,t){const n=Date.now();return!(e<n-t)&&(!(e>n)||(ke(`Detected an update time that is in the future: ${e} > ${n}`),!1))}zi(){this.document!==null&&typeof this.document.addEventListener=="function"&&(this.ki=()=>{this.xi.enqueueAndForget(()=>(this.inForeground=this.document.visibilityState==="visible",this.Gi()))},this.document.addEventListener("visibilitychange",this.ki),this.inForeground=this.document.visibilityState==="visible")}hs(){this.ki&&(this.document.removeEventListener("visibilitychange",this.ki),this.ki=null)}ji(){var e;typeof((e=this.window)===null||e===void 0?void 0:e.addEventListener)=="function"&&(this.Li=()=>{this.ls();const t=/(?:Version|Mobile)\/1[456]/;ld()&&(navigator.appVersion.match(t)||navigator.userAgent.match(t))&&this.xi.enterRestrictedMode(!0),this.xi.enqueueAndForget(()=>this.shutdown())},this.window.addEventListener("pagehide",this.Li))}Ps(){this.Li&&(this.window.removeEventListener("pagehide",this.Li),this.Li=null)}cs(e){var t;try{const n=((t=this.Wi)===null||t===void 0?void 0:t.getItem(this.us(e)))!==null;return V(bt,`Client '${e}' ${n?"is":"is not"} zombied in LocalStorage`),n}catch(n){return ke(bt,"Failed to get zombied client id.",n),!1}}ls(){if(this.Wi)try{this.Wi.setItem(this.us(this.clientId),String(Date.now()))}catch(e){ke("Failed to set zombie client id.",e)}}Ts(){if(this.Wi)try{this.Wi.removeItem(this.us(this.clientId))}catch{}}us(e){return`firestore_zombie_${this.persistenceKey}_${e}`}}function Lr(r){return me(r,wi)}function as(r){return me(r,Yn)}function nT(r,e){let t=r.projectId;return r.isDefaultDatabase||(t+="."+r.database),"firestore/"+e+"/"+t+"/"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ua="RestConnection",fT={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class pT{get Uo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Ko=t+"://"+e.host,this.Wo=`projects/${n}/databases/${i}`,this.Go=this.databaseId.database===li?`project_id=${n}`:`project_id=${n}&database_id=${i}`}zo(e,t,n,i,s){const o=qa(),c=this.jo(e,t.toUriEncodedString());V(ua,`Sending RPC '${e}' ${o}:`,c,n);const u={"google-cloud-resource-prefix":this.Wo,"x-goog-request-params":this.Go};this.Ho(u,i,s);const{host:h}=new URL(c),f=or(h);return this.Jo(e,c,u,n,f).then(m=>(V(ua,`Received RPC '${e}' ${o}: `,m),m),m=>{throw mn(ua,`RPC '${e}' ${o} failed with error: `,m,"url: ",c,"request:",n),m})}Yo(e,t,n,i,s,o){return this.zo(e,t,n,i,s)}Ho(e,t,n){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+ur}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((i,s)=>e[s]=i),n&&n.headers.forEach((i,s)=>e[s]=i)}jo(e,t){const n=fT[e];return`${this.Ko}/v1/${t}:${n}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mT{constructor(e){this.Zo=e.Zo,this.Xo=e.Xo}e_(e){this.t_=e}n_(e){this.r_=e}i_(e){this.s_=e}onMessage(e){this.o_=e}close(){this.Xo()}send(e){this.Zo(e)}__(){this.t_()}a_(){this.r_()}u_(e){this.s_(e)}c_(e){this.o_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _T(){return typeof window<"u"?window:null}function ws(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function go(r){return new Iv(r,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mh="PersistentStream";class Up{constructor(e,t,n,i,s,o,c,u){this.xi=e,this.S_=n,this.D_=i,this.connection=s,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=c,this.listener=u,this.state=0,this.v_=0,this.C_=null,this.F_=null,this.stream=null,this.M_=0,this.x_=new Fp(e,t)}O_(){return this.state===1||this.state===5||this.N_()}N_(){return this.state===2||this.state===3}start(){this.M_=0,this.state!==4?this.auth():this.B_()}async stop(){this.O_()&&await this.close(0)}L_(){this.state=0,this.x_.reset()}k_(){this.N_()&&this.C_===null&&(this.C_=this.xi.enqueueAfterDelay(this.S_,6e4,()=>this.q_()))}Q_(e){this.U_(),this.stream.send(e)}async q_(){if(this.N_())return this.close(0)}U_(){this.C_&&(this.C_.cancel(),this.C_=null)}K_(){this.F_&&(this.F_.cancel(),this.F_=null)}async close(e,t){this.U_(),this.K_(),this.x_.cancel(),this.v_++,e!==4?this.x_.reset():t&&t.code===S.RESOURCE_EXHAUSTED?(ke(t.toString()),ke("Using maximum backoff delay to prevent overloading the backend."),this.x_.p_()):t&&t.code===S.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.W_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.i_(t)}W_(){}auth(){this.state=1;const e=this.G_(this.v_),t=this.v_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([n,i])=>{this.v_===t&&this.z_(n,i)},n=>{e(()=>{const i=new N(S.UNKNOWN,"Fetching auth token failed: "+n.message);return this.j_(i)})})}z_(e,t){const n=this.G_(this.v_);this.stream=this.H_(e,t),this.stream.e_(()=>{n(()=>this.listener.e_())}),this.stream.n_(()=>{n(()=>(this.state=2,this.F_=this.xi.enqueueAfterDelay(this.D_,1e4,()=>(this.N_()&&(this.state=3),Promise.resolve())),this.listener.n_()))}),this.stream.i_(i=>{n(()=>this.j_(i))}),this.stream.onMessage(i=>{n(()=>++this.M_==1?this.J_(i):this.onNext(i))})}B_(){this.state=5,this.x_.y_(async()=>{this.state=0,this.start()})}j_(e){return V(Mh,`close with error: ${e}`),this.stream=null,this.close(4,e)}G_(e){return t=>{this.xi.enqueueAndForget(()=>this.v_===e?t():(V(Mh,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class yT extends Up{constructor(e,t,n,i,s,o){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,n,i,o),this.serializer=s}H_(e,t){return this.connection.I_("Listen",e,t)}J_(e){return this.onNext(e)}onNext(e){this.x_.reset();const t=Tv(this.serializer,e),n=function(s){if(!("targetChange"in s))return q.min();const o=s.targetChange;return o.targetIds&&o.targetIds.length?q.min():o.readTime?Ne(o.readTime):q.min()}(e);return this.listener.Y_(t,n)}Z_(e){const t={};t.database=Oa(this.serializer),t.addTarget=function(s,o){let c;const u=o.target;if(c=Ls(u)?{documents:dp(s,u)}:{query:fp(s,u).gt},c.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){c.resumeToken=ap(s,o.resumeToken);const h=Na(s,o.expectedCount);h!==null&&(c.expectedCount=h)}else if(o.snapshotVersion.compareTo(q.min())>0){c.readTime=ir(s,o.snapshotVersion.toTimestamp());const h=Na(s,o.expectedCount);h!==null&&(c.expectedCount=h)}return c}(this.serializer,e);const n=Av(this.serializer,e);n&&(t.labels=n),this.Q_(t)}X_(e){const t={};t.database=Oa(this.serializer),t.removeTarget=e,this.Q_(t)}}class IT extends Up{constructor(e,t,n,i,s,o){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,n,i,o),this.serializer=s}get ea(){return this.M_>0}start(){this.lastStreamToken=void 0,super.start()}W_(){this.ea&&this.ta([])}H_(e,t){return this.connection.I_("Write",e,t)}J_(e){return U(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,U(!e.writeResults||e.writeResults.length===0,55816),this.listener.na()}onNext(e){U(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.x_.reset();const t=wv(e.writeResults,e.commitTime),n=Ne(e.commitTime);return this.listener.ra(n,t)}ia(){const e={};e.database=Oa(this.serializer),this.Q_(e)}ta(e){const t={streamToken:this.lastStreamToken,writes:e.map(n=>qs(this.serializer,n))};this.Q_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const En="RemoteStore";class wT{constructor(e,t,n,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Ia=[],this.Ea=new Map,this.da=new Set,this.Aa=[],this.Ra=s,this.Ra.No(o=>{n.enqueueAndForget(async()=>{wn(this)&&(V(En,"Restarting streams for network reachability change."),await async function(u){const h=z(u);h.da.add(4),await Ci(h),h.Va.set("Unknown"),h.da.delete(4),await _o(h)}(this))})}),this.Va=new TT(n,i)}}async function _o(r){if(wn(r))for(const e of r.Aa)await e(!0)}async function Ci(r){for(const e of r.Aa)await e(!1)}function Bp(r,e){const t=z(r);t.Ea.has(e.targetId)||(t.Ea.set(e.targetId,e),Oc(t)?xc(t):dr(t).N_()&&Nc(t,e))}function kc(r,e){const t=z(r),n=dr(t);t.Ea.delete(e),n.N_()&&qp(t,e),t.Ea.size===0&&(n.N_()?n.k_():wn(t)&&t.Va.set("Unknown"))}function Nc(r,e){if(r.ma.Ke(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(q.min())>0){const t=r.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}dr(r).Z_(e)}function qp(r,e){r.ma.Ke(e),dr(r).X_(e)}function xc(r){r.ma=new mv({getRemoteKeysForTarget:e=>r.remoteSyncer.getRemoteKeysForTarget(e),Rt:e=>r.Ea.get(e)||null,Pt:()=>r.datastore.serializer.databaseId}),dr(r).start(),r.Va.ca()}function Oc(r){return wn(r)&&!dr(r).O_()&&r.Ea.size>0}function wn(r){return z(r).da.size===0}function jp(r){r.ma=void 0}async function AT(r){r.Va.set("Online")}async function RT(r){r.Ea.forEach((e,t)=>{Nc(r,e)})}async function bT(r,e){jp(r),Oc(r)?(r.Va.Pa(e),xc(r)):r.Va.set("Unknown")}async function PT(r,e,t){if(r.Va.set("Online"),e instanceof op&&e.state===2&&e.cause)try{await async function(i,s){const o=s.cause;for(const c of s.targetIds)i.Ea.has(c)&&(await i.remoteSyncer.rejectListen(c,o),i.Ea.delete(c),i.ma.removeTarget(c))}(r,e)}catch(n){V(En,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Gs(r,n)}else if(e instanceof vs?r.ma.Xe(e):e instanceof sp?r.ma.ot(e):r.ma.nt(e),!t.isEqual(q.min()))try{const n=await Mp(r.localStore);t.compareTo(n)>=0&&await function(s,o){const c=s.ma.It(o);return c.targetChanges.forEach((u,h)=>{if(u.resumeToken.approximateByteSize()>0){const f=s.Ea.get(h);f&&s.Ea.set(h,f.withResumeToken(u.resumeToken,o))}}),c.targetMismatches.forEach((u,h)=>{const f=s.Ea.get(u);if(!f)return;s.Ea.set(u,f.withResumeToken(he.EMPTY_BYTE_STRING,f.snapshotVersion)),qp(s,u);const m=new ct(f.target,u,h,f.sequenceNumber);Nc(s,m)}),s.remoteSyncer.applyRemoteEvent(c)}(r,t)}catch(n){V(En,"Failed to raise snapshot:",n),await Gs(r,n)}}async function Gs(r,e,t){if(!zt(e))throw e;r.da.add(1),await Ci(r),r.Va.set("Offline"),t||(t=()=>Mp(r.localStore)),r.asyncQueue.enqueueRetryable(async()=>{V(En,"Retrying IndexedDB access"),await t(),r.da.delete(1),await _o(r)})}function zp(r,e){return e().catch(t=>Gs(r,t,e))}async function Vi(r){const e=z(r),t=qt(e);let n=e.Ia.length>0?e.Ia[e.Ia.length-1].batchId:on;for(;ST(e);)try{const i=await uT(e.localStore,n);if(i===null){e.Ia.length===0&&t.k_();break}n=i.batchId,CT(e,i)}catch(i){await Gs(e,i)}$p(e)&&Kp(e)}function ST(r){return wn(r)&&r.Ia.length<10}function CT(r,e){r.Ia.push(e);const t=qt(r);t.N_()&&t.ea&&t.ta(e.mutations)}function $p(r){return wn(r)&&!qt(r).O_()&&r.Ia.length>0}function Kp(r){qt(r).start()}async function VT(r){qt(r).ia()}async function DT(r){const e=qt(r);for(const t of r.Ia)e.ta(t.mutations)}async function kT(r,e,t){const n=r.Ia.shift(),i=vc.from(n,e,t);await zp(r,()=>r.remoteSyncer.applySuccessfulWrite(i)),await Vi(r)}async function NT(r,e){e&&qt(r).ea&&await async function(n,i){if(function(o){return fv(o)&&o!==S.ABORTED}(i.code)){const s=n.Ia.shift();qt(n).L_(),await zp(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,i)),await Vi(n)}}(r,e),$p(r)&&Kp(r)}async function Lh(r,e){const t=z(r);t.asyncQueue.verifyOperationInProgress(),V(En,"RemoteStore received new credentials");const n=wn(t);t.da.add(3),await Ci(t),n&&t.Va.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.da.delete(3),await _o(t)}async function xT(r,e){const t=z(r);e?(t.da.delete(2),await _o(t)):e||(t.da.add(2),await Ci(t),t.Va.set("Unknown"))}function dr(r){return r.fa||(r.fa=function(t,n,i){const s=z(t);return s.oa(),new yT(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(r.datastore,r.asyncQueue,{e_:AT.bind(null,r),n_:RT.bind(null,r),i_:bT.bind(null,r),Y_:PT.bind(null,r)}),r.Aa.push(async e=>{e?(r.fa.L_(),Oc(r)?xc(r):r.Va.set("Unknown")):(await r.fa.stop(),jp(r))})),r.fa}function qt(r){return r.ga||(r.ga=function(t,n,i){const s=z(t);return s.oa(),new IT(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(r.datastore,r.asyncQueue,{e_:()=>Promise.resolve(),n_:VT.bind(null,r),i_:NT.bind(null,r),na:DT.bind(null,r),ra:kT.bind(null,r)}),r.Aa.push(async e=>{e?(r.ga.L_(),await Vi(r)):(await r.ga.stop(),r.Ia.length>0&&(V(En,`Stopping write stream with ${r.Ia.length} pending writes`),r.Ia=[]))})),r.ga}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nt{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new nt(this.firestore,e,this._query)}}class Ee{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new lt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Ee(this.firestore,e,this._key)}}class lt extends nt{constructor(e,t,n){super(e,t,Ri(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Ee(this.firestore,null,new O(e))}withConverter(e){return new lt(this.firestore,e,this._path)}}function uw(r,e,...t){if(r=ne(r),rm("collection","path",e),r instanceof Io){const n=X.fromString(e,...t);return Gh(n),new lt(r,null,n)}{if(!(r instanceof Ee||r instanceof lt))throw new N(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(X.fromString(e,...t));return Gh(n),new lt(r.firestore,null,n)}}function am(r,e,...t){if(r=ne(r),arguments.length===1&&(e=cc.newId()),rm("doc","path",e),r instanceof Io){const n=X.fromString(e,...t);return Kh(n),new Ee(r,null,new O(n))}{if(!(r instanceof Ee||r instanceof lt))throw new N(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(X.fromString(e,...t));return Kh(n),new Ee(r.firestore,r instanceof lt?r.converter:null,new O(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Aw(r){r=Ce(r,Ee);const e=Ce(r.firestore,He);return ow(fr(e),r._key).then(t=>Im(e,r,t))}class eu extends ym{constructor(e){super(),this.firestore=e}convertBytes(e){return new vn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Ee(this.firestore,null,t)}}function Rw(r){r=Ce(r,nt);const e=Ce(r.firestore,He),t=fr(e),n=new eu(e);return gm(r._query),aw(t,r._query).then(i=>new Zc(e,n,r,i))}function bw(r,e,t){r=Ce(r,Ee);const n=Ce(r.firestore,He),i=Jc(r.converter,e,t);return mr(n,[Gc(Ni(n),"setDoc",r._key,i,r.converter!==null,t).toMutation(r._key,fe.none())])}function Pw(r,e,t,...n){r=Ce(r,Ee);const i=Ce(r.firestore,He),s=Ni(i);let o;return o=typeof(e=ne(e))=="string"||e instanceof pr?hm(s,"updateDoc",r._key,e,t,n):lm(s,"updateDoc",r._key,e),mr(i,[o.toMutation(r._key,fe.exists(!0))])}function Sw(r){return mr(Ce(r.firestore,He),[new Pi(r._key,fe.none())])}function Cw(r,e){const t=Ce(r.firestore,He),n=am(r),i=Jc(r.converter,e);return mr(t,[Gc(Ni(r.firestore),"addDoc",n._key,i,r.converter!==null,{}).toMutation(n._key,fe.exists(!1))]).then(()=>n)}function Vw(r,...e){var t,n,i;r=ne(r);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||Xh(e[o])||(s=e[o],o++);const c={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Xh(e[o])){const m=e[o];e[o]=(t=m.next)===null||t===void 0?void 0:t.bind(m),e[o+1]=(n=m.error)===null||n===void 0?void 0:n.bind(m),e[o+2]=(i=m.complete)===null||i===void 0?void 0:i.bind(m)}let u,h,f;if(r instanceof Ee)h=Ce(r.firestore,He),f=Ri(r._key.path),u={next:m=>{e[o]&&e[o](Im(h,r,m))},error:e[o+1],complete:e[o+2]};else{const m=Ce(r,nt);h=Ce(m.firestore,He),f=m._query;const g=new eu(h);u={next:b=>{e[o]&&e[o](new Zc(h,g,m,b))},error:e[o+1],complete:e[o+2]},gm(r._query)}return function(g,b,C,k){const D=new $c(k),$=new qc(b,D,C);return g.asyncQueue.enqueueAndForget(async()=>Fc(await Ws(g),$)),()=>{D.xu(),g.asyncQueue.enqueueAndForget(async()=>Uc(await Ws(g),$))}}(fr(h),f,c,u)}function mr(r,e){return function(n,i){const s=new et;return n.asyncQueue.enqueueAndForget(async()=>WT(await sw(n),i,s)),s.promise}(fr(r),e)}function Im(r,e,t){const n=t.docs.get(e._key),i=new eu(r);return new Xc(r,i,e._key,n,new Bn(t.hasPendingWrites,t.fromCache),e.converter)}class Dw{constructor(e){let t;this.kind="persistent",e!=null&&e.tabManager?(e.tabManager._initialize(e),t=e.tabManager):(t=Em(void 0),t._initialize(e)),this._onlineComponentProvider=t._onlineComponentProvider,this._offlineComponentProvider=t._offlineComponentProvider}toJSON(){return{kind:this.kind}}}function kw(r){return new Dw(r)}class Nw{constructor(e){this.forceOwnership=e,this.kind="persistentSingleTab"}toJSON(){return{kind:this.kind}}_initialize(e){this._onlineComponentProvider=Hs.provider,this._offlineComponentProvider={build:t=>new nw(t,e==null?void 0:e.cacheSizeBytes,this.forceOwnership)}}}function Em(r){return new Nw(r==null?void 0:r.forceOwnership)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ow(r){return fr(r=Ce(r,He)),new vm(r,e=>mr(r,e))}(function(e,t=!0){(function(i){ur=i})(ar),Kn(new un("firestore",(n,{instanceIdentifier:i,options:s})=>{const o=n.getProvider("app").getImmediate(),c=new He(new ZI(n.getProvider("auth-internal")),new nE(o,n.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new N(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ft(h.options.projectId,f)}(o,i),o);return s=Object.assign({useFetchStreams:t},s),c._setSettings(s),c},"PUBLIC").setMultipleInstances(!0)),sn(kl,Nl,e),sn(kl,Nl,"esm2017")})();const Xw=Object.freeze(Object.defineProperty({__proto__:null,AbstractUserDataWriter:ym,Bytes:vn,CollectionReference:lt,DocumentReference:Ee,DocumentSnapshot:Xc,FieldPath:pr,FieldValue:ki,Firestore:He,FirestoreError:N,GeoPoint:Eo,Query:nt,QueryCompositeFilterConstraint:Ro,QueryConstraint:Ao,QueryDocumentSnapshot:ei,QueryFieldFilterConstraint:Oi,QueryLimitConstraint:Po,QueryOrderByConstraint:bo,QuerySnapshot:Zc,SnapshotMetadata:Bn,Timestamp:ae,VectorValue:vo,WriteBatch:vm,_AutoId:cc,_ByteString:he,_DatabaseId:Ft,_DocumentKey:O,_EmptyAuthCredentialsProvider:uf,_FieldPath:oe,_cast:Ce,_logWarn:mn,_validateIsNotUsedTogether:im,addDoc:Cw,collection:uw,connectFirestoreEmulator:om,deleteDoc:Sw,doc:am,ensureFirestoreConfigured:fr,executeWrite:mr,getDoc:Aw,getDocs:Rw,getFirestore:hw,initializeFirestore:lw,limit:Tw,onSnapshot:Vw,orderBy:vw,persistentLocalCache:kw,persistentSingleTabManager:Em,query:Iw,serverTimestamp:xw,setDoc:bw,updateDoc:Pw,where:Ew,writeBatch:Ow},Symbol.toStringTag,{value:"Module"}));export{$w as A,Cw as B,hw as C,Uw as D,qw as E,Bw as F,Lw as G,Qw as H,cr as I,Fw as J,Gw as K,Xw as L,ae as T,zw as a,Mw as b,jw as c,md as d,lw as e,Em as f,Yw as g,uw as h,R_ as i,Rw as j,Ow as k,am as l,xw as m,Tw as n,Hw as o,kw as p,Iw as q,vw as r,Ww as s,Vw as t,Sw as u,bw as v,Ew as w,Aw as x,Kw as y,Pw as z};
