import{ManualSyncUtility as r}from"./manualSync-CvIE5YuC.js";import"./index-2Db1VkVG.js";import"./vendor-mui-BiZRk4jb.js";import"./vendor-react-DBJs7CER.js";import"./vendor-i18n-fNoC129p.js";import"./vendor-firebase-Bz7DBBYX.js";import"./vendor-charts-CTO3gyqW.js";const o=async()=>{console.log("🆘 EMERGENCY FIX: Starting immediate sync...");try{const e=await r.syncAppointmentsToPatients("demo-clinic");return"error"in e?(console.error("❌ Emergency fix failed:",e.error),typeof window<"u"&&alert(`❌ Emergency fix failed: ${e.error}`),!1):(console.log("🎉 Emergency fix completed:",e),typeof window<"u"&&alert(`🎉 EMERGENCY FIX COMPLETED!
