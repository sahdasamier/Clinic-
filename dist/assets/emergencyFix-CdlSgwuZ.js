import{ManualSyncUtility as r}from"./manualSync-BAKIW1P-.js";import"./index-CmZbfp3_.js";import"./vendor-mui-Cg8Kh_xn.js";import"./vendor-react-DZOuCmRv.js";import"./vendor-i18n-C3m40H8x.js";import"./vendor-firebase-CbnFHwo5.js";import"./vendor-charts-DY_1IFuD.js";const o=async()=>{console.log("🆘 EMERGENCY FIX: Starting immediate sync...");try{const e=await r.syncAppointmentsToPatients("demo-clinic");return"error"in e?(console.error("❌ Emergency fix failed:",e.error),typeof window<"u"&&alert(`❌ Emergency fix failed: ${e.error}`),!1):(console.log("🎉 Emergency fix completed:",e),typeof window<"u"&&alert(`🎉 EMERGENCY FIX COMPLETED!
