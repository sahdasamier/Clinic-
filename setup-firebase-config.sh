...
# This script will create a .env file with the correct Firebase configuration

echo "🔥 Setting up Firebase configuration for clinic-d9c0a..."

# Create .env file with Firebase configuration
cat > .env << 'EOF'
# Firebase Configuration for clinic-d9c0a
# Generated from firebase apps:sdkconfig web
...
VITE_FIREBASE_VAPID_KEY=BLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
# Emulator URLs (if using emulators)
...
echo "   Auth Domain: clinic-d9c0a.firebaseapp.com"
echo "   Storage Bucket: clinic-d9c0a.firebasestorage.app"
echo ""
echo "🔄 Please restart your development server to apply the new configuration."
echo "💡 If you're still having issues, check the Firebase console for any additional setup requirements."
